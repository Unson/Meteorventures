        ...
        <div className="relative z-10 max-w-[100rem] mx-auto px-6 md:px-12">
          ...
          >
            ...
            <p className="font-paragraph text-lg md:text-xl text-foreground/80 leading-relaxed">
              Real tactics and insights from running campaigns. No generic advice, no fluff—just what actually works for small businesses in 2026.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            {isLoading ? null : insights.length > 0 ? (
              ...
              <div className="text-center py-20">
                <p className="font-paragraph text-lg text-foreground/60">
                  No insights available yet. Check back soon for practical SEO and marketing tactics.
                </p>
              </div>
            )}
          </div>
